...
public class ZippopotamApiException extends MtIdException {

    private static final Errors ERROR_CODE = Errors.ZIPPOPOTAM_API_UNAVAILABLE;
    private static final Integer STATUS_CODE = 503;

    public ZippopotamApiException(String externalResponse) {
